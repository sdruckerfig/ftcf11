<cfcomponent output="false">
	...
	<cfset this.name = "ProposalManager73Solution">
	...
	<cfset this.wschannels = [
	   {name : "chat", 
	    cfcListener : "components.ChatListener"
	   }
	]>
	
	<cffunction name="onApplicationStart">
		
		<cfset application.basehref = "/ftcf11/walksolution/walk7-3/">
		<cfset application.cfcpath = "ftcf11.walksolution.walk7-3.components.">
